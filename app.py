...
PREDICTED_LABELS = {'benign': 'benign', 'malignant':'malignant'} #categories -> what's on screen in the app 

def get_prediction(image_data): #expects parameter image data
  #replace your image classification ai service URL
  url = 'https://askai.aiclub.world/660cff13-2dc4-4215-99c9-dc426ef67b25'  
